...
function ProductDetails() {
  ...
  const buyNow = () => {
    ...
    cartItems.push(bike);
    localStorage.setItem("cart", JSON.stringify(cartItems));
    alert(`${bike.title} added to cart! Now redirecting to checkout.`);
    navigate("/checkout");
  };
          ...
          <div className="flex flex-col md:flex-row space-y-6 md:space-x-6">
            ...
            <div className="w-full md:w-1/2 space-y-4">
              ...
              <div className="mt-4 bg-gray-200 p-4 rounded-lg">
                ...
                {/* <h3 className="text-xl font-bold text-red-800">Stolen Bike</h3> */}
                <p>
                  Manufacturar Name:{" "}
                ...
                <p>
                  Year of Manufacturar:{" "}
                  <span className=" font-bold">{bike.year}</span>
                </p>
                {/* <p>Location: {bike.stolen_location}</p>
                  <p>Serial Number: {bike.serial}</p> */}
                {/* <p>Coordinates: {bike.stolen_coordinates ? `Lat: ${bike.stolen_coordinates[0]}, Long: ${bike.stolen_coordinates[1]}` : "Not available"}</p> */}
              </div>
              {/* )} */}
